...
@Feature("Выход по кнопке «Выйти» в личном кабинете")
public class LogoutUserTest {

    public static final String PAGE_URL = "https://stellarburgers.nomoreparties.site";
    public static final String USER_EMAIL = "kransekake@gmail.com";
    ...
    @Test
    @DisplayName("LogoutUserFromProfile()")
    @Description("Проверка выхода по кнопке «Выйти» в личном кабинете")
    public void LogoutUserFromProfile() {
